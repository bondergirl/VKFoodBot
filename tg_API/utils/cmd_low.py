...
async def cmd_low(message: Message, state: FSMContext):
    ...
    await state.set_state(LowStates.input_food)


@router.message(StateFilter(LowStates.input_food), F.text.isalpha())
async def food_sent(message: Message, state: FSMContext):
    ...
    await state.set_state(LowStates.input_count)


@router.message(StateFilter(LowStates.input_food))
